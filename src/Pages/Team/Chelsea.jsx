...
import PlayersChelsea from '../../Components/Card/Chelsea/Chelsea'
import PlayersChelseaGK from '../../Components/Card/Chelsea/ChelseaGK'
...
export default class Chelsea extends Component {
  ...
  componentDidMount() {
      // GOALKEEPER
      axios.get(API_URL+"Chelsea?position.id=1&&_sort=number&_order=asc")
      .then(res => {
      ...
      // DEFENDER
      axios.get(API_URL+"Chelsea?position.id=2&&_sort=number&_order=asc")
      .then(res => {
      ...
      // MIDFIELDER
      axios.get(API_URL+"Chelsea?position.id=3&&_sort=number&_order=asc")
      .then(res => {
      ...
      // FORWARD
      axios.get(API_URL+"Chelsea?position.id=4&&_sort=number&_order=asc")
      .then(res => {
