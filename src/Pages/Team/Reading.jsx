...
import PlayersReading from '../../Components/Card/Reading/Reading'
import PlayersReadingGK from '../../Components/Card/Reading/ReadingGK'
...
export default class Reading extends Component {
  ...
  componentDidMount() {
      // GOALKEEPER
      axios.get(API_URL+"Reading?position.id=1&&_sort=number&_order=asc")
      .then(res => {
      ...
      // DEFENDER
      axios.get(API_URL+"Reading?position.id=2&&_sort=number&_order=asc")
      .then(res => {
      ...
      // MIDFIELDER
      axios.get(API_URL+"Reading?position.id=3&&_sort=number&_order=asc")
      .then(res => {
      ...
      // FORWARD
      axios.get(API_URL+"Reading?position.id=4&&_sort=number&_order=asc")
      .then(res => {
