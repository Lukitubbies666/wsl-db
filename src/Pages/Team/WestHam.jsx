...
import PlayersWHU from '../../Components/Card/West Ham/WestHam'
import PlayersWHUGK from '../../Components/Card/West Ham/WestHamGK'


export default class WestHam extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
      // GOALKEEPER
      axios.get(API_URL+"WestHam?position.id=1&&_sort=number&_order=asc")
      .then(res => {
      ...
      // DEFENDER
      axios.get(API_URL+"WestHam?position.id=2&&_sort=number&_order=asc")
      .then(res => {
      ...
      // MIDFIELDER
      axios.get(API_URL+"WestHam?position.id=3&&_sort=number&_order=asc")
      .then(res => {
      ...
      // FORWARD
      axios.get(API_URL+"WestHam?position.id=4&&_sort=number&_order=asc")
      .then(res => {
