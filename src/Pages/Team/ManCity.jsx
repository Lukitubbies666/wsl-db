...
import PlayersManCity from '../../Components/Card/Man City/ManCity'
import PlayersManCityGK from '../../Components/Card/Man City/ManCityGK'


export default class ManCity extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
      // GOALKEEPER
      axios.get(API_URL+"ManCity?position.id=1&&_sort=number&_order=asc")
      .then(res => {
      ...
      // DEFENDER
      axios.get(API_URL+"ManCity?position.id=2&&_sort=number&_order=asc")
      .then(res => {
      ...
      // MIDFIELDER
      axios.get(API_URL+"ManCity?position.id=3&&_sort=number&_order=asc")
      .then(res => {
      ...
      // FORWARD
      axios.get(API_URL+"ManCity?position.id=4&&_sort=number&_order=asc")
      .then(res => {
