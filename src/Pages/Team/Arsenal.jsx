...
import PlayersArsenal from '../../Components/Card/Arsenal/Arsenal'
import PlayersArsenalGK from '../../Components/Card/Arsenal/ArsenalGK'



export default class Arsenal extends Component {
  constructor(props) {
    super(props)
  ...
  Styling = {
		containerpage: "px-4 py-16 mx-auto lg:max-w-screen md:px-24 lg:px-8 lg:py-20",
		title: "font-sans text-4xl font-bold leading-tight text-gray-900 sm:text-4xl sm:text-center",
    containertitle:"max-w-xl mb-2 sm:mx-auto",
...
// comment
  ...
  componentDidMount() {
      // GOALKEEPER
      axios.get(API_URL+"Arsenal?position.id=1&&_sort=number&_order=asc")
      .then(res => {
      ...
      // DEFENDER
      axios.get(API_URL+"Arsenal?position.id=2&&_sort=number&_order=asc")
      .then(res => {
      ...
      // MIDFIELDER
      axios.get(API_URL+"Arsenal?position.id=3&&_sort=number&_order=asc")
      .then(res => {
      ...
      // FORWARD
      axios.get(API_URL+"Arsenal?position.id=4&&_sort=number&_order=asc")
      .then(res => {
