...
import PlayersBirmingham from '../../Components/Card/Birmingham/Birmingham'
import PlayersBirminghamGK from '../../Components/Card/Birmingham/BirminghamGK'


export default class Birmingham extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
      // GOALKEEPER
      axios.get(API_URL+"Birmingham?position.id=1&&_sort=number&_order=asc")
      .then(res => {
      ...
      // DEFENDER
      axios.get(API_URL+"Birmingham?position.id=2&&_sort=number&_order=asc")
      .then(res => {
      ...
      // MIDFIELDER
      axios.get(API_URL+"Birmingham?position.id=3&&_sort=number&_order=asc")
      .then(res => {
      ...
      // FORWARD
      axios.get(API_URL+"Birmingham?position.id=4&&_sort=number&_order=asc")
      .then(res => {
