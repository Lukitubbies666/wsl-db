...
import PlayersLeicester from '../../Components/Card/Leicester/Leicester'
import PlayersLeicesterGK from '../../Components/Card/Leicester/LeicesterGK'


export default class Leicester extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
      // GOALKEEPER
      axios.get(API_URL+"Leicester?position.id=1&&_sort=number&_order=asc")
      .then(res => {
      ...
      // DEFENDER
      axios.get(API_URL+"Leicester?position.id=2&&_sort=number&_order=asc")
      .then(res => {
      ...
      // MIDFIELDER
      axios.get(API_URL+"Leicester?position.id=3&&_sort=number&_order=asc")
      .then(res => {
      ...
      // FORWARD
      axios.get(API_URL+"Leicester?position.id=4&&_sort=number&_order=asc")
      .then(res => {
