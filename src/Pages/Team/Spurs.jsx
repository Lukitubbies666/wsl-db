...
import PlayersSpurs from '../../Components/Card/Spurs/Spurs'
import PlayersSpursGK from '../../Components/Card/Spurs/SpursGK'


export default class Spurs extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
      // GOALKEEPER
      axios.get(API_URL+"Tottenham?position.id=1&&_sort=number&_order=asc")
      .then(res => {
      ...
      // DEFENDER
      axios.get(API_URL+"Tottenham?position.id=2&&_sort=number&_order=asc")
      .then(res => {
      ...
      // MIDFIELDER
      axios.get(API_URL+"Tottenham?position.id=3&&_sort=number&_order=asc")
      .then(res => {
      ...
      // FORWARD
      axios.get(API_URL+"Tottenham?position.id=4&&_sort=number&_order=asc")
      .then(res => {
