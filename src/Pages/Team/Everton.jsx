...
import PlayersEverton from '../../Components/Card/Everton/Everton'
import PlayersEvertonGK from '../../Components/Card/Everton/EvertonGK'


export default class Everton extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
      // GOALKEEPER
      axios.get(API_URL+"Everton?position.id=1&&_sort=number&_order=asc")
      .then(res => {
      ...
      // DEFENDER
      axios.get(API_URL+"Everton?position.id=2&&_sort=number&_order=asc")
      .then(res => {
      ...
      // MIDFIELDER
      axios.get(API_URL+"Everton?position.id=3&&_sort=number&_order=asc")
      .then(res => {
      ...
      // FORWARD
      axios.get(API_URL+"Everton?position.id=4&&_sort=number&_order=asc")
      .then(res => {
