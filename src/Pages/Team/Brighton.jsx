...
import PlayersBrighton from '../../Components/Card/Brighton/Brighton'
import PlayersBrightonGK from '../../Components/Card/Brighton/BrightonGK'
...
export default class Brighton extends Component {
  ...
  componentDidMount() {
      // GOALKEEPER
      axios.get(API_URL+"Brighton?position.id=1&&_sort=number&_order=asc")
      .then(res => {
      ...
      // DEFENDER
      axios.get(API_URL+"Brighton?position.id=2&&_sort=number&_order=asc")
      .then(res => {
      ...
      // MIDFIELDER
      axios.get(API_URL+"Brighton?position.id=3&&_sort=number&_order=asc")
      .then(res => {
      ...
      // FORWARD
      axios.get(API_URL+"Brighton?position.id=4&&_sort=number&_order=asc")
      .then(res => {
