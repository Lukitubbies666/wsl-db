...
import PlayersVilla from '../../Components/Card/Aston Villa/AstonVilla'
import PlayersVillaGK from '../../Components/Card/Aston Villa/AstonVillaGK'


export default class AstonVilla extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
      // GOALKEEPER
      axios.get(API_URL+"AstonVilla?position.id=1&&_sort=number&_order=asc")
      .then(res => {
      ...
      // DEFENDER
      axios.get(API_URL+"AstonVilla?position.id=2&&_sort=number&_order=asc")
      .then(res => {
      ...
      // MIDFIELDER
      axios.get(API_URL+"AstonVilla?position.id=3&&_sort=number&_order=asc")
      .then(res => {
      ...
      // FORWARD
      axios.get(API_URL+"AstonVilla?position.id=4&&_sort=number&_order=asc")
      .then(res => {
